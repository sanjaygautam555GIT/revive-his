(()=>{
  ...
  window.doctorDischargeForm=function(a,d){
    ...
    const fields=[
      ["Final Diagnosis",d.final_diagnosis,true],["Presenting Complaints / History",d.presenting_history,true],["Examination Findings",d.examination_findings,false],["Important Investigations",d.important_investigations,false],["Hospital Course",d.hospital_course,false],["Surgery / Procedure",d.procedure_performed,false],["Intra-operative Findings",d.intraoperative_findings,true],["Treatment Given",d.treatment_given,false],["Condition at Discharge",d.condition_at_discharge,false],["Discharge Medicines",d.discharge_medicines,true],["Diet / Activity Advice",d.diet_activity_advice,false],["Wound / Dressing Advice",d.wound_dressing_advice,false],["Follow-up",d.follow_up,false],["Warning Signs / When to Return",d.warning_signs,true]
    ];
