...
const ROLE_LABELS={owner:"Owner – Observe only",staff:"Staff – OPD/IPD/Billing",pharmacyOwner:"Pharmacy Owner – Stock/Purchase",pharmacy:"Pharmacy Staff – Billing only",accountant:"Accountant – Expenses/Reports"};
